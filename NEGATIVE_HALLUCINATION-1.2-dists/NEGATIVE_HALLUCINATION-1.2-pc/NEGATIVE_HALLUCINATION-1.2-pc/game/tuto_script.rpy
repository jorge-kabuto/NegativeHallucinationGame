...
# Skills, sound effects, and voice acting tutorial:
    ...
    # action Function("color('LOGIC','intel')")
    # color "— I know about cause and effect." (intel)
    # "{color=[intel]}LOGIC{/color} — I know about cause and effect."
    # "[logic_ch]I know about cause and effect."
    color "I know about cause and effect." (color="#6cc6ce", character="LOGIC")
    tw "I know about cause and effect."
    # twice "I know about cause and effect."

    play sound sfx_psy
    tw "{color=[psy]}VOLITION{/color} — I keep your humanity."
    ...
    tw "There is a giant ball there. And evil
...
# Basic text and choices tutorial:
    ...
    #     apes. And the evil apes are dukin' it out on the ball. You're one of them.
    #     It's basically all just evil apes dukin' it out on a giant ball.
    #     {p}{p}You've created a new Ren'Py game." (items =)
